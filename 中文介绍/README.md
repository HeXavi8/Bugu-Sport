...
#### 2. 野球功能——查找场地、寻找球友、师生参与</br>
    这里有10个学校29个校区的体育场地信息。
    在这里同学们可以选择特定学校、特定校区的场地，选择自己想要进行体育运动的时间，发起或者加入到一场野球比赛当中。
...
#### 4. 认证功能——赛事认证、队伍认证、个人认证</br>
    在这里同学们可获得创建赛事的权限、获得创建队伍的权限、以及进行个人身份、管理员身份的认证。
    <img src="https://github.com/HeXavi8/BUGU-Sport/blob/main/images/certification.PNG" width = "200"/>

#### 5. 赛事功能——查找赛事、加入赛事、发布资讯</br>
    作为赛事创建者，可以对参赛者进行管理、对比赛的详情、进程、数据进行上传展示。
    同学们也可以搜索自己感兴趣的比赛，以个人或者队伍身份加入到赛事当中。
...
#### 6. 个人功能——私信、验证信息、个人主页</br>
    在这里同学们可以处理自己收到的私信并进行回复。
    验证收到的约赛信息，加入队伍或赛事的信息。
    查看并展示自己的个人主页。
...
### 开发者心得
    ...
    经过一段时间对校园体育的探索，我们也发现了诸多问题以及阻力，但我们为校园体育发展助力的愿望依然在，因此也真心希望越来越多的人关注校园体育、投身到校园体育发展当中，为国内体育的发展提供一种不一样的可能。
