# 不咕约球
  ...
  - [开发目的](#开发目的)
  - [功能介绍](#功能介绍)
    - [约赛功能——发送邀请、协商比赛、跨校交流](#约赛功能)
    - [野球功能——查找场地、寻找球友、师生参与](#野球功能)
    - [队伍功能——查找队伍、加入队伍](#队伍功能)
    - [认证功能——赛事认证、队伍认证、个人认证](#认证功能)
    - [赛事功能——查找赛事、加入赛事、发布资讯](#赛事功能)
    - [个人功能——私信、验证信息、个人主页](#个人功能)
  - [未来期望](#未来期望)
  - [开发者心得](#开发者心得)
...
## 开发目的 <a name = "开发目的"></a>
   ...
   * 增加学校之间体育交流途径，通过体育赛事，让不同学校、校区的同学们拥有更多直接交流的机会，让他们得以扩展个人的社交圈、学习交流合作的渠道。 
   * 尝试组织开展一年一度的校园间的体育比赛，打造成学校之间的名片。（参考牛津剑桥大学一年一度的赛艇比赛、哈佛耶鲁大学一年一度的橄榄球比赛）
   * 提高校园体育的活动氛围和影响力，探索校园体育文化的形成与内涵。从而让同学们可以在校园内体验到更好的运动生活。
   * 增强校园体育专业性，尝试将专业资源引入校园，探索为职业体坛扩展选材面积的可能性。（参考美国校园篮球发展，日本校园足球发展。） 
   * 学习借鉴NCAA等成熟的学生体育联盟，探索校园体育的商业价值。


## 功能介绍 <a name = "功能介绍"></a>
### 约赛功能——发送邀请、协商比赛、跨校交流 <a name = "约赛功能"></a>
